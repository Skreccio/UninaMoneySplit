...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        panel1.add(bottoneCrea, new com.intellij.uiDesigner.core.GridConstraints(5, 1, 1, 1, com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER, com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_SHRINK | com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_GROW, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        bottoneAnnulla = new JButton();
        bottoneAnnulla.setText("Annulla");
        panel1.add(bottoneAnnulla, new com.intellij.uiDesigner.core.GridConstraints(5, 2, 1, 1, com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER, com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_SHRINK | com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_GROW, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
    ...
    public NuovoGruppoDialog(JFrame parent, String matricolaCreatore) {
        super(parent, "Nuovo gruppo", true); // true = modale
        ...
        // Ricerca "live": ogni carattere digitato aggiorna la lista
    ...
    private void onCercaUtenti() {
        ...
        try {
            java.util.List<Utente> risultati = invitoController.cercaUtenti(testo);
    ...
    private void onCrea() {
        ...
        try {
            ...
            java.util.List<Utente> selezionati = listaUtenti.getSelectedValuesList();
